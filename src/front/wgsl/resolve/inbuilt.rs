...
impl ToStaticString for SampledTextureType {
    fn to_static_str(&self) -> &'static str {
        match *self {
            ...
            SampledTextureType::TextureMultisampled2dArray => "texture_multisampled_2d_array",
...
impl From<SampledTextureType> for (ImageDimension, bool, bool) {
    fn from(ty: SampledTextureType) -> (ImageDimension, bool, bool) {
        match ty {
            ...
            SampledTextureType::TextureMultisampled2dArray => (ImageDimension::D2, true, true),

...
void main() {
    vec4 _e0 = builtins();
    vec4 _e1 = splat();
    vec3 _e9 = bool_cast(vec3(1.0, 1.0, 1.0));
    logical();
    arithmetic();
    bit();
    comparison();

...
vec4 test_textureLoad_1d(int coords, int level) {
    ...
    vec4 _e3 = texelFetch(_group_0_binding_0_fs, clamp(int(coords), 0, textureSize(_group_0_binding_0_fs, _e3_clamped_lod) - 1), _e3_clamped_lod);
    return _e3;
}
...
vec4 test_textureLoad_2d(ivec2 coords_1, int level_1) {
    ...
    vec4 _e4 = texelFetch(_group_0_binding_1_fs, clamp(ivec2(coords_1), ivec2(0), textureSize(_group_0_binding_1_fs, _e4_clamped_lod) - ivec2(1)), _e4_clamped_lod);
    return _e4;
}
...
vec4 test_textureLoad_3d(ivec3 coords_3, int level_3) {
    ...
    vec4 _e6 = texelFetch(_group_0_binding_3_fs, clamp(ivec3(coords_3), ivec3(0), textureSize(_group_0_binding_3_fs, _e6_clamped_lod) - ivec3(1)), _e6_clamped_lod);
    return _e6;
}

vec4 test_textureLoad_multisampled_2d(ivec2 coords_4, int _sample) {
    vec4 _e7 = texelFetch(_group_0_binding_4_fs, clamp(ivec2(coords_4), ivec2(0), textureSize(_group_0_binding_4_fs) - ivec2(1)), clamp(_sample, 0, textureSamples(_group_0_binding_4_fs) - 1)
);
    return _e7;
}

...
void main() {
    vec4 _e0 = test_textureLoad_1d(0, 0);
    vec4 _e3 = test_textureLoad_2d(ivec2(0, 0), 0);
    vec4 _e6 = test_textureLoad_2d_array(ivec2(0, 0), 0, 0);
    vec4 _e10 = test_textureLoad_3d(ivec3(0, 0, 0), 0);
    vec4 _e13 = test_textureLoad_multisampled_2d(ivec2(0, 0), 0);

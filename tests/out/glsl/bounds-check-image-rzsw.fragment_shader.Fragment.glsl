...
vec4 test_textureLoad_1d(int coords, int level) {
    vec4 _e3 = (level < textureQueryLevels(_group_0_binding_0_fs) && ivec1(coords) < textureSize(_group_0_binding_0_fs, level) ? texelFetch(_group_0_binding_0_fs, ivec1(coords), level) : vec4(0.0));
    return _e3;
}

vec4 test_textureLoad_2d(ivec2 coords_1, int level_1) {
    vec4 _e4 = (level_1 < textureQueryLevels(_group_0_binding_1_fs) && all(lessThan(ivec2(coords_1), textureSize(_group_0_binding_1_fs, level_1))) ? texelFetch(_group_0_binding_1_fs, ivec2(coords_1), level_1) : vec4(0.0));
    return _e4;
}
...
vec4 test_textureLoad_3d(ivec3 coords_3, int level_3) {
    vec4 _e6 = (level_3 < textureQueryLevels(_group_0_binding_3_fs) && all(lessThan(ivec3(coords_3), textureSize(_group_0_binding_3_fs, level_3))) ? texelFetch(_group_0_binding_3_fs, ivec3(coords_3), level_3) : vec4(0.0));
    return _e6;
}

vec4 test_textureLoad_multisampled_2d(ivec2 coords_4, int _sample) {
    vec4 _e7 = (_sample < textureSamples(_group_0_binding_4_fs) && all(lessThan(ivec2(coords_4), textureSize(_group_0_binding_4_fs))) ? texelFetch(_group_0_binding_4_fs, ivec2(coords_4), _sample) : vec4(0.0));
    return _e7;
}
...
void test_textureStore_2d(ivec2 coords_9, vec4 value_1) {
    imageStore(_group_0_binding_9_fs, ivec2(coords_9), value_1);
    return;
}
...
void test_textureStore_3d(ivec3 coords_11, vec4 value_3) {
    imageStore(_group_0_binding_11_fs, ivec3(coords_11), value_3);
    return;
}

...
void main() {
    ...
    uvec4 value1_ = texelFetch(_group_0_binding_0_cs, ivec2(itc), int(local_id.z));
    uvec4 value2_ = texelFetch(_group_0_binding_3_cs, ivec2(itc), int(local_id.z));
    uvec4 value4_ = imageLoad(_group_0_binding_1_cs, ivec2(itc));

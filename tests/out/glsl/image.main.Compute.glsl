...
void main() {
    ...
    uvec4 value1u = texelFetch(_group_0_binding_0_cs, uvec2(itc), int(local_id.z));
    uvec4 value2u = texelFetch(_group_0_binding_3_cs, uvec2(itc), int(local_id.z));
    uvec4 value4u = imageLoad(_group_0_binding_1_cs, uvec2(itc));

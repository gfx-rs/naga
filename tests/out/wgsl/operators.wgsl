...
fn main() {
    let _e0 = builtins();
    let _e1 = splat();
    let _e9 = bool_cast(vec3<f32>(1.0, 1.0, 1.0));
    logical();
    arithmetic();
    bit();
    comparison();

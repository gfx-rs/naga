fn main_1() {
    ...
    i = ((ctz(_e223) + 1) % 33) - 1;
    let _e226 = i2_;
    i2_ = ((ctz(_e226) + 1) % 33) - 1;
    let _e229 = i3_;
    i3_ = ((ctz(_e229) + 1) % 33) - 1;
    let _e232 = i4_;
    i4_ = ((ctz(_e232) + 1) % 33) - 1;
    let _e235 = u;
    i = ((ctz(_e235) + 1) % 33) - 1;
    let _e238 = u2_;
    i2_ = ((ctz(_e238) + 1) % 33) - 1;
    let _e241 = u3_;
    i3_ = ((ctz(_e241) + 1) % 33) - 1;
    let _e244 = u4_;
    i4_ = ((ctz(_e244) + 1) % 33) - 1;
    let _e247 = i;
    i = ((clz(_e247) + 1) % 33) - 1;
    let _e250 = i2_;
    i2_ = ((clz(_e250) + 1) % 33) - 1;
    let _e253 = i3_;
    i3_ = ((clz(_e253) + 1) % 33) - 1;
    let _e256 = i4_;
    i4_ = ((clz(_e256) + 1) % 33) - 1;
    let _e259 = u;
    i = ((clz(_e259) + 1) % 33) - 1;
    let _e262 = u2_;
    i2_ = ((clz(_e262) + 1) % 33) - 1;
    let _e265 = u3_;
    i3_ = ((clz(_e265) + 1) % 33) - 1;
    let _e268 = u4_;
    i4_ = ((clz(_e268) + 1) % 33) - 1;
    return;
}

...
void main()
{
    ...
    uint ctz_a = firstbitlow(0u);
    uint ctz_b = firstbitlow(4294967295u);
    uint2 ctz_c = firstbitlow((1u).xx);
    uint2 ctz_d = firstbitlow((0u).xx);
    int clz_a = (-1 < 0 ? 0 : 31 - firstbithigh(-1));
    uint clz_b = asuint(31 - firstbithigh(1u));
    int2 _expr30 = (-1).xx;
    int2 clz_c = (_expr30 < (0).xx ? (0).xx : (31).xx - firstbithigh(_expr30));

...
void arithmetic()
{
    ...
    float3 _expr376 = float3(0.0, 0.0, 0.0);
    float3 _expr379 = float3(0.0, 0.0, 0.0);
    float3x3 add = ((float3x3)0 + (float3x3)0);
    float3 _expr385 = float3(0.0, 0.0, 0.0);
    float3 _expr388 = float3(0.0, 0.0, 0.0);
    float3x3 sub = ((float3x3)0 - (float3x3)0);
    float3 _expr394 = float3(0.0, 0.0, 0.0);
    float3x3 mul_scalar0_ = float3x3(float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0));
    float3 _expr412 = float3(0.0, 0.0, 0.0);
    float3x3 mul_scalar1_ = float3x3(float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0));
    float3 _expr431 = float3(0.0, 0.0, 0.0);
    float3 mul_vector0_ = mul((1.0).xxxx, (float4x3)0);
    float3 _expr440 = float3(0.0, 0.0, 0.0);
    float4 mul_vector1_ = mul((float4x3)0, (2.0).xxx);
    float3 _expr446 = float3(0.0, 0.0, 0.0);
    float4 _expr449 = float4(0.0, 0.0, 0.0, 0.0);
...
void main()
{
    ...
    const float3 _e9 = bool_cast(float3(1.0, 1.0, 1.0));
    logical();
    arithmetic();
    bit();
    comparison();

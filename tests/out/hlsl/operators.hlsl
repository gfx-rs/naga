...
void arithmetic()
{
    ...
    float3 _expr340 = float3(0.0, 0.0, 0.0);
    float3 _expr343 = float3(0.0, 0.0, 0.0);
    float3x3 add = ((float3x3)0 + (float3x3)0);
    float3 _expr349 = float3(0.0, 0.0, 0.0);
    float3 _expr352 = float3(0.0, 0.0, 0.0);
    float3x3 sub = ((float3x3)0 - (float3x3)0);
    float3 _expr356 = float3(0.0, 0.0, 0.0);
    float3x3 mul_scalar0_ = float3x3(float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0));
    float3 _expr372 = float3(0.0, 0.0, 0.0);
    float3x3 mul_scalar1_ = float3x3(float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0));
    float3 _expr391 = float3(0.0, 0.0, 0.0);
    float3 mul_vector0_ = mul((1.0).xxxx, (float4x3)0);
    float3 _expr400 = float3(0.0, 0.0, 0.0);
    float4 mul_vector1_ = mul((float4x3)0, (2.0).xxx);
    float3 _expr406 = float3(0.0, 0.0, 0.0);
    float4 _expr409 = float4(0.0, 0.0, 0.0, 0.0);
...
void main()
{
    ...
    const float3 _e8 = bool_cast(float3(1.0, 1.0, 1.0));
    logical();
    arithmetic();
    bit();
    comparison();
